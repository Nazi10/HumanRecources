...
public class ProjectsServiceImpl implements ProjectsServiceInterface {
    ...
    @Override
    public String changeProjectStatus(UUID projectsId, Boolean status) {
        Projects project = projectsRepo.getProjectsByProjectId(projectsId);
        project.setStatus(status);
        projectsRepo.save(project);
        return "This project is now: "+ status;
    }
